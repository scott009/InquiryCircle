      ...
      <div class="bg-white shadow overflow-hidden sm:rounded-md">
        <div class="px-4 py-5 sm:px-6">
          ...
          <p class="mt-1 max-w-2xl text-sm text-gray-500">
            Circles you can join or are participating in
          </p>
        </div>
        ...
        <div v-else class="px-4 py-5 sm:p-6 text-center">
          ...
          <h3 class="mt-2 text-sm font-medium text-gray-900">No circles available</h3>
          <p class="mt-1 text-sm text-gray-500">
            {{ authStore.isFacilitator 
              ? 'No circles found. Create one from your dashboard.' 
              : 'No circles available to join at the moment.' }}
          </p>
